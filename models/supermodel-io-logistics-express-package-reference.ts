...
/**
    ...
    * @enum {string}
    */
export enum SupermodelIoLogisticsExpressPackageReferenceTypeCodeEnum {
    AAO = 'AAO',
    CU = 'CU',
    FF = 'FF',
    FN = 'FN',
